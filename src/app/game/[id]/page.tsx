            ...
            <div className="game-section-header">
              ...
              <div className="game-section-title-wrapper">
                <div className="game-section-icon">
                  <img src="/games/game-icons/fire.png" alt="Other games" className="hidden sm:block object-contain" />
                  <img src="/games/side-icon/like.svg" alt="Other games" className="block sm:hidden object-contain" />
                </div>
