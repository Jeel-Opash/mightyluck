    ...
    <>
      ...
      <div className={`
        ...
        ${sidebarOpen
          ...
          : '-translate-x-full lg:translate-x-0 w-full lg:w-[232px] opacity-100 pointer-events-none lg:pointer-events-auto'
        }
      `}>
        ...
        {/* =========================================================================
           ...
           ========================================================================= */}
        <div className="hidden lg:flex flex-col gap-[10px] w-[232px]">
          {/* 1. TOP PROMO CARDS */}
        ...
        <div className="flex lg:hidden flex-col w-full pt-[30px] pb-[80px] px-[20px] items-center justify-start">
          ...
          <div className="w-full max-w-[374px] flex flex-col gap-[16px]">
            ...
            >
              <button
                onClick={() => setCasinoExpanded(!casinoExpanded)}
                className="flex items-center justify-between w-full h-[50px] bg-[#1463FF] hover:bg-[#2e74ff] px-[10px] rounded-[8px] transition-colors cursor-pointer focus:outline-none shrink-0"
              >
                <div className="flex items-center gap-[12px] w-[160px] h-[22px]">
                  <img src="/games/side-icon/casino.svg" className="w-[20px] h-[20px] object-contain" alt="Casino" />
            ...
            {/* Live Casino Accordion/Button */}
            <button onClick={() => { dispatch(toggleSidebar()); }} className="flex items-center justify-between w-full h-[50px] bg-[#1463FF] hover:bg-[#2e74ff] px-[10px] rounded-[8px] transition-colors cursor-pointer focus:outline-none shrink-0">
              <div className="flex items-center gap-[12px] w-[160px] h-[22px]">
                <img src="/games/side-icon/live.svg" className="w-[20px] h-[20px] object-contain" alt="Live Casino" />
