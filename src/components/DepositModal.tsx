...
export default function DepositModal({ isOpen, onClose }: DepositModalProps) {
  ...
  const [selectedPayment, setSelectedPayment] = useState<'Bitcoin' | 'Credit Card'>('Credit Card');
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 backdrop-blur-sm p-3 sm:p-4">
      ...
      <div className="relative w-full max-w-[500px] max-h-[95vh] overflow-y-auto bg-[#091741] rounded-[16px] flex flex-col items-center p-5 sm:p-[24px_20px_32px] gap-[24px] isolation-isolate border border-white/10 shadow-2xl">
        {/* Crest Glowing Aura */}
        <div className="absolute w-[173px] h-[173px] left-[calc(50%-173px/2)] top-[-145px] bg-[#1463FF] filter blur-[40px] pointer-events-none z-0" />

        {/* Modal Header — centered icon + title, close on right */}
        <div className="flex flex-row items-center w-full h-[36px] z-10 relative">
          {/* Centered wallet + title */}
          <div className="absolute left-1/2 -translate-x-1/2 flex flex-row items-center gap-[10px]">
            <img src="/games/wallet.svg" alt="Wallet" width={28} height={28} className="object-contain" />
            <span className="font-jost font-extrabold text-[22px] leading-[32px] tracking-[0.01em] text-white">Wallet</span>
          </div>
          {/* Close button */}
          <button
            onClick={onClose}
            className="ml-auto w-8 h-8 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center text-white/60 hover:text-white transition-all cursor-pointer"
          >
        ...
        {/* Tab Buttons bar */}
        <div className="flex flex-row items-center gap-[8px] w-full h-[30px] z-10">
          {[
            ...
            return (
              <button
                ...
                className="flex-1 h-[30px] rounded-[6px] flex items-center justify-center font-sans text-[12px] font-semibold tracking-[0.02em] cursor-pointer hover:brightness-110 active:scale-98 transition-all duration-150"
              >
                {tab.label}
              </button>
            );
        ...
        {/* Main Content Area */}
        <div className="flex flex-col items-start p-[16px] gap-[16px] w-full h-[375px] bg-[#0C1F56] rounded-[16px] z-10 overflow-y-auto scrollbar-thin scrollbar-thumb-white/5">
          {depositConfirmed ? (
            ...
            <>
              {/* 1. Select a Bonus */}
              <div className="flex flex-col items-start gap-[8px] w-full relative" ref={bonusDropdownRef}>
                ...
                <div 
                  ...
                  className="flex flex-row items-center justify-between px-[16px] w-full h-[40px] bg-[#112F82] rounded-[8px] cursor-pointer hover:bg-[#153a9e] transition-all duration-150"
                >
                ...
                {isBonusDropdownOpen && (
                  <div className="absolute top-[68px] left-0 right-0 bg-[#0C1F56] rounded-[8px] border-2 border-[#1463FF] shadow-2xl z-[9999] overflow-hidden flex flex-col">
                    <div className="px-[16px] py-[12px] border-b border-white/5 font-sans font-bold text-[12px] text-white">
              ...
              <div className="flex flex-col items-start gap-[8px] w-full relative" ref={paymentDropdownRef}>
                <span className="font-sans font-semibold text-[12px] leading-[16px] tracking-[0.02em] text-[#BBCAF3]">
                ...
                <div 
                  ...
                  className="flex flex-row items-center justify-between px-[16px] w-full h-[39px] bg-[#112F82] rounded-[8px] cursor-pointer hover:bg-[#153a9e] transition-all duration-150 border border-white/5"
                >
                  <div className="flex flex-row items-center gap-[8px]">
                    {selectedPayment === 'Bitcoin' ? (
                      <>
                        <img src="/images/bitcoin.svg" alt="BTC" className="w-[16px] h-[16px] object-contain shrink-0" />
                        <div className="flex flex-row items-center gap-[8px]">
                          <span className="font-sans font-bold text-[14px] leading-[19px] tracking-[0.02em] text-white">
                            Bitcoin
                          </span>
                ...
                {isPaymentDropdownOpen && (
                  <div className="absolute top-[68px] left-0 right-0 bg-[#112F82] rounded-[8px] border border-white/10 shadow-xl z-50 overflow-hidden">
                    ...
                    <div 
                      ...
                      className="flex flex-row items-center justify-between px-[16px] py-[10px] text-white font-sans text-[13px] hover:bg-[#1463FF] cursor-pointer transition-colors"
                    >
                      <div className="flex flex-row items-center gap-[8px]">
              ...
              {selectedPayment === 'Bitcoin' ? (
                <>
                  {/* WARNING NOTE */}
                  <div className="flex flex-row items-start gap-[8px] w-full mt-[-8px]">
                    ...
                    <span className="font-sans font-medium text-[10px] leading-[14px] tracking-[0.02em] text-[#7795E8] select-none">
                      Only deposit BTC via the corresponding network. Deposit of other assets or from other networks will be lost.
                    </span>
                  </div>
                  ...
                  <div className="flex flex-col items-start gap-[8px] w-full">
                    ...
                    <div className="flex flex-row justify-center items-center gap-[8px] w-full h-[40px]">
                      <div className="flex flex-row items-center px-[16px] gap-[12px] flex-grow h-full bg-[#112F82] rounded-[8px] border border-white/5">
                        <img src="/images/doller.svg" alt="USD" className="w-[16px] h-[16px] object-contain shrink-0" />
                        <input 
                          type="number"
                          value={usdAmount}
                      ...
                      <button 
                        ...
                        className="w-[40px] h-[40px] bg-[#1463FF] hover:bg-[#2c75ff] rounded-[8px] flex items-center justify-center text-white shrink-0 active:scale-90 transition-transform cursor-pointer"
                      >
                  ...
                  <div className="flex flex-col items-start gap-[8px] w-full relative">
                    ...
                    <div className="flex flex-row items-center justify-between px-[16px] w-full h-[40px] bg-[#112F82] rounded-[8px] border border-white/5">
                      <span className="font-sans font-semibold text-[14px] leading-[19px] tracking-[0.02em] text-[#7795E8] truncate max-w-[270px] select-all">
                        {btcAddress}
                      </span>
                      ...
                      <div className="flex flex-row items-center gap-[12px] shrink-0">
                        <button 
                          onClick={copyAddress}
                          className="w-[16px] h-[16px] text-[#BBCAF3] hover:text-white transition-colors cursor-pointer relative"
                          title="Copy Address"
                        >
                          {copied ? (
                        ...
                        <button 
                          ...
                          className="w-[16px] h-[16px] text-[#BBCAF3] hover:text-white transition-colors cursor-pointer"
                          title="Show QR Code"
                        >
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex flex-col items-start gap-[12px] w-full">
                  ...
                  <input 
                    ...
                    className="w-full h-[40px] px-[16px] bg-[#112F82] rounded-[8px] border border-white/5 font-sans font-semibold text-[14px] leading-[19px] text-white placeholder-[#A5B8EF]/60 outline-none focus:border-white/10"
                    placeholder="Street"
                  />
                  ...
                  <div className="flex flex-row gap-[8px] w-full">
                    <input 
                      ...
                      className="flex-1 h-[40px] px-[16px] bg-[#112F82] rounded-[8px] border border-white/5 font-sans font-semibold text-[14px] leading-[19px] text-white placeholder-[#A5B8EF]/60 outline-none focus:border-white/10"
                      placeholder="City"
                    />
                    <input 
                      type="text"
                  ...
                  <div className="flex flex-row gap-[8px] w-full relative">
                    ...
                    <div className="flex-1 relative" ref={countryDropdownRef}>
                      ...
                      {isCountryDropdownOpen && (
                        <div className="absolute bottom-[48px] left-0 right-0 bg-[#112F82] rounded-[8px] border border-white/10 shadow-xl z-50 overflow-hidden">
                          {[
                ...
                <div className="flex flex-col items-start gap-[12px] w-full">
                    ...
                    <div className="flex flex-row items-center justify-between w-full">
                      ...
                      {creditCardStep === 'payment' && (
                        <button 
                          ...
                          className="font-sans font-semibold text-[10px] text-[#7795E8] hover:text-white transition-colors cursor-pointer flex items-center gap-1"
                        >
                    ...
                    <div className="flex flex-row items-center gap-[8px] w-full h-[40px]">
                      {[20, 30, 100].map((amount) => {
                        ...
                        return (
                          <button
                            ...
                            className={`flex-1 h-full rounded-[8px] flex items-center justify-center font-sans font-bold text-[14px] leading-[19px] transition-all cursor-pointer ${
                              isActive 
                                ? 'bg-[#1463FF] border-2 border-[#1463FF] text-white' 
                                : 'bg-[#112F82] border border-white/5 text-[#A5B8EF] hover:bg-[#153a9e]'
                            }`}
                          >
                            ${amount}
                          </button>
                      ...
                      <div className="flex-1 h-full relative">
                        {ccAmountOption === 'custom' ? (
                          <div className="flex flex-row items-center px-[12px] w-full h-full bg-[#112F82] border-2 border-[#1463FF] rounded-[8px]">
                          ...
                          <button
                            ...
                            className="w-full h-full rounded-[8px] bg-[#112F82] border border-white/5 text-[#A5B8EF] hover:bg-[#153a9e] flex items-center justify-center font-sans font-bold text-[14px] leading-[19px] cursor-pointer"
                          >
                            Custom...
                          </button>
                        )}
                  ...
                  <div className="flex flex-col items-start gap-[8px] w-full">
                    ...
                    <input 
                      ...
                      onChange={(e) => {
                        // Truncate non-digits and format credit card number with spaces (e.g. 1111 2222 3333 4444)
          ...
          {activeTab === 'bonuses' && (
            <div className="flex flex-col gap-[16px] w-full h-full select-none">
              ...
              <div className="flex flex-col gap-[8px] w-full">
                ...
                >
                  {/* Input — 320×40px, p:10px 16px, r:8px, #112F82 */}
                  <div
                    style={{
                      display: 'flex',
                      flexDirection: 'row',
                  ...
                  >
                    ...
                    >
                      <input
                        ...
                        onFocus={(e) => {
                          (e.currentTarget.parentElement?.parentElement?.parentElement as HTMLElement).style.boxShadow = '0 0 0 1.5px rgba(20,99,255,0.6)';
                        }}
                        onBlur={(e) => {
                          (e.currentTarget.parentElement?.parentElement?.parentElement as HTMLElement).style.boxShadow = 'none';
                        }}
                      />
                    </div>
                  </div>
                  {/* Apply — 100×40px, px-30 py-10, Manrope 700 14/19px, r-8 */}
                  <button
                    type="button"
                    onClick={() => {
              ...
              >
                {[
                  ...
                  >
                    ...
                    {/* Stats container — 260×81px, col gap-9 */}
                    <div
                      style={{
                        display: 'flex',
                        flexDirection: 'column',
                    ...
                    {/* Activate btn — 260×40px, p-10/20, Manrope 700 12/16px, r-6 */}
                    <button
                      type="button"
          ...
          {activeTab === 'withdraw' && (
            <div className="flex flex-col items-center justify-center w-full h-full gap-4 text-center select-none py-8">
        ...
        {activeTab !== 'bonuses' && (depositConfirmed ? (
          /* ── Confirmed state CTA ── */
          <div className="flex flex-col items-center gap-[12px] w-full z-10 shrink-0">
            <button
              onClick={onClose}
              className="w-[300px] h-[50px] bg-[#FFC83D] hover:bg-[#ffd362] rounded-[8px] flex items-center justify-center font-sans font-bold text-[15px] leading-[19px] text-[#1A1404] tracking-[0.02em] cursor-pointer active:scale-95 transition-all duration-150 shadow-[0_4px_16px_rgba(255,200,61,0.35)]"
            >
              Go to games
            </button>
          ...
          <button
            ...
            className="w-[300px] h-[50px] bg-[#FFC83D] hover:bg-[#ffd362] rounded-[8px] flex items-center justify-center font-sans font-bold text-[14px] leading-[19px] text-[#1A1404] tracking-[0.02em] cursor-pointer active:scale-95 transition-all duration-150 z-10 shrink-0"
          >
