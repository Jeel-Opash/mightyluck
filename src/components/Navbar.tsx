...
export default function Navbar() {
  ...
  return (
    <header className="relative z-[60] w-full max-w-[1440px] h-[60px] bg-[#0C1F56] border-b border-white/5 select-none isolate flex flex-row justify-between items-center px-3 sm:px-[24px] py-[10px] gap-2 sm:gap-[50px] mx-auto shrink-0">
      ...
      <div className="flex flex-row items-center gap-[10px] w-auto h-[40px] z-10 order-2 relative shrink-0">
        ...
        {isAuthenticated && user ? (
          ...
          <div style={{
            ...
            {/* Notification & Gift Wrapper - hidden on very small screens */}
